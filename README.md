...
| Pkg folder | [packages\crypto-standard-aliases](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\crypto-standard-aliases) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package crypto-standard-aliases -Apply
