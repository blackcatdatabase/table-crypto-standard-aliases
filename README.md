...
- Pkg folder: [packages\crypto-standard-aliases](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\crypto-standard-aliases)
...
graph LR
  ...
  crypto_standard_aliases["crypto_standard_aliases"]:::center
  crypto_standard_aliases -->|FK| crypto_algorithms["crypto_algorithms"]:::link
...
- Outbound (depends on): "crypto_algorithms"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package crypto-standard-aliases -Apply
