...
final class CryptoStandardAliasesModule implements ModuleInterface
{
    public function name(): string { return 'table-crypto_standard_aliases'; }
    public function table(): string { return 'crypto_standard_aliases'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-crypto_algorithms' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_crypto_alias_algo' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_crypto_alias_algo' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_crypto_alias_algo' ],
            'foreignKeys' => [ 'fk_crypto_alias_algo' ],
        ];
    }
}
