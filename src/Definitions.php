...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'crypto_standard_aliases'; }
    public static function contractView(): string { return 'vw_crypto_standard_aliases'; }
    /** @return string[] */
    public static function columns(): array { return [ 'alias', 'algo_id', 'notes', 'created_at' ]; }
     ...
     * alias may be "id" or "col1, col2".
     * @return string[]
     */
    public static function pkColumns(): array {
        $raw = trim('alias');
        if ($raw === '') {
            throw new \InvalidArgumentException('Definitions::pkColumns(): token alias must not be empty.');
        }
    ...
    public static function defaultOrder(): ?string {
        $c = trim('created_at DESC, alias DESC'); return $c !== '' ? $c : null;
    }

    /** @return array<int,array<int,string>> list of unique keys */
    public static function uniqueKeys(): array { return [ [ 'alias' ] ]; }
    ...
    public static function intColumns(): array { return [ 'algo_id' ]; }
