...
namespace BlackCat\Database\Packages\CryptoStandardAliases\Mapper;

use BlackCat\Database\Packages\CryptoStandardAliases\Dto\CryptoStandardAliaseDto;
use BlackCat\Database\Packages\CryptoStandardAliases\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO CryptoStandardAliaseDto:
 ...
 */
final class CryptoStandardAliaseDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'alias' => 'alias', 'algo_id' => 'algoId', 'notes' => 'notes', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'algo_id' ];
    /** @var string[] */
     ...
     * @return CryptoStandardAliaseDto
     */
    public static function fromRow(array $row): CryptoStandardAliaseDto
    {
        /** @var CryptoStandardAliaseDto */
        return DtoHydrator::fromRow(
            CryptoStandardAliaseDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?CryptoStandardAliaseDto
    {
     ...
     *
     * @param CryptoStandardAliaseDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(CryptoStandardAliaseDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(CryptoStandardAliaseDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(CryptoStandardAliaseDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,CryptoStandardAliaseDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,CryptoStandardAliaseDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(CryptoStandardAliaseDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,CryptoStandardAliaseDto>
     */
