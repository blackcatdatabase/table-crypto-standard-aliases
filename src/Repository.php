...
use BlackCat\Database\Packages\CryptoStandardAliases\Repository\CryptoStandardAliaseRepository;
...
{
    private CryptoStandardAliaseRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new CryptoStandardAliaseRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\CryptoStandardAliases\Dto\CryptoStandardAliaseDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\CryptoStandardAliases\Dto\CryptoStandardAliaseDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\CryptoStandardAliases\Dto\CryptoStandardAliaseDto|null
    {
