...
namespace BlackCat\Database\Packages\CryptoStandardAliases;
...
use BlackCat\Database\Packages\CryptoStandardAliases\Repository\CryptoStandardAliaseRepository as GeneratedRepository;
...
{
  private CryptoStandardAliaseRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof CryptoStandardAliaseRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected CryptoStandardAliaseRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\CryptoStandardAliases\Dto\CryptoStandardAliaseDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\CryptoStandardAliases\Dto\CryptoStandardAliaseDto|null { return $this->repo->getById($id, $asDto); }
